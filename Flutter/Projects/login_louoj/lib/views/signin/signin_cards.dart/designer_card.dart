...
import 'package:login_louoj/controller/signin/card/designer_card_controller.dart';
...
class DesignerCard extends StatelessWidget {
  DesignerCard({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    DesignerCardController controller = DesignerCardController();
    return Container(
      width: Get.width * 0.7,
