...
import 'package:login_louoj/controller/signin/card/stylist_card_controller.dart';
...
class StylistCard extends StatelessWidget {
  StylistCard({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    StylistCardController controller = StylistCardController();
    return Container(
      width: Get.width * 0.7,
